...
def helper_test_is_satisfied(filename, R, location,
    ...
    actual = schelling.is_satisfied(grid, R, location,
                                    simil_threshold, occup_threshold)
    if actual != expected:
...
def test_2():
    # Check boundary neighborhood: top left corner. Neither threshold
    # is reached.
    filename = "tests/a19-sample-writeup.txt"
...
def test_4():
    # Check boundary neighborhood: top right corner. Occupancy
    # threshold reached, similarity threshold is not.

    filename = "tests/a19-sample-writeup.txt"
    helper_test_is_satisfied(filename, 1, (0, 4), 0.7, 0.7, False)

def test_5():
    # Check boundary neighborhood: top right corner and different
    # values for thresholds. Similarity threshold reached, occupancy
    # threshold is not.
    filename = "tests/a19-sample-writeup.txt"
...
def test_8():
    # Check boundary neighborhood: lower left corner and different
